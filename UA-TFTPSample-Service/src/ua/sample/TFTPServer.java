...
/**
 * A server program that responds to TFTP WRQ requests (RRQ is not implemented)
 * (Default port of 69)
 * 
 * @author adbetz
 *
...
public class TFTPServer
{
    ...
    /**
     * TODO: Wondering of ways to turn this into a multi-threaded application to
     * handle multiple requests simultaneously ... probably need to transform this
     * logic into a Thread class of some sort, and then let the main routine of the
     * server class handle and start threads upon each new request.
     * 
     * @param args
     */
    ...
    /**
     * Just a simple message processing loop. TODO: If we turned this into a
     * multi-threaded version, we probably wouldn't need the loop.
     * 
     * @throws IOException
     */
    ...
    private void doWriteRequest(DatagramPacket request) throws IOException
    {
        ...
        /**
         * While we haven't received the last packet: 1. Get the next packet 2. Make
         * sure its a data packet, report error if not 3. Get the bytes from the data
         * packet, write them to the byte array output stream 4. Send corresponding ACK
         * response. 5. Increase block count
         */
        do
        {
    ...
    /**
     * Helper method for writing received bytes from data packets to file. TODO:
     * unclear how the mode is used here.
     * 
     * @param baoStream
     * @param fileName
     * @param mode
